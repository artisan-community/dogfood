...
describe('The release command', function () {
    ...
    it('calls the create command correctly with title and notes', function () {
    ...
    it('calls the create command correctly without title and notes', function () {
    ...
    it('calls the uploadAsset command correctly with a label', function () {
    ...
    it('calls the uploadAsset command correctly without a label', function () {
    ...
    it('calls the edit command correctly with title and notes', function () {
    ...
    it('calls the edit command correctly without title and notes', function () {
