<x-verbstream::action-section>
    ...
    <x-slot name="content">
        ...
        <x-verbstream::dialog-modal wire:model.live="confirmingUserDeletion">
            <x-slot name="title">
                {{ __('Delete Account') }}
            </x-slot>
            ...
            <x-slot name="footer">
                ...
                <flux:button variant="primary" class="ms-3" wire:click="deleteUser" wire:loading.attr="disabled">
                    {{ __('Delete Account') }}
                </flux:button>
            </x-slot>
