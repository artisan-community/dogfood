<x-verbstream::form-section submit="updateProfileInformation">
    <x-slot name="title">
    ...
    <x-slot name="form">
        ...
        @if (ArtisanBuild\Verbstream\Verbstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <x-verbstream::label for="photo" value="{{ __('Photo') }}"/>
                ...
                <x-verbstream::input-error for="photo" class="mt-2"/>
            </div>
        @endif
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <flux:input :label="__('Name')" id="name" type="text" class="mt-1 block w-full" wire:model="state.name" required
                     autocomplete="name"/>
        ...
        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <flux:input :label="__('Email')" id="email" type="email" class="mt-1 block w-full" wire:model="state.email" required
