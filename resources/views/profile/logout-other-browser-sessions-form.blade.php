    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <flux:modal.trigger name="confirm-logout">
                <flux:button wire:click="confirmLogout" wire:loading.attr="disabled">
                    {{ __('Log Out Other Browser Sessions') }}
                </flux:button>
            </flux:modal.trigger>

            <flux:modal name="confirm-logout" class="space-y-6">
                <flux:heading class="!text-xl">{{ __('Log Out Other Browser Sessions') }}</flux:heading>
                ...
                <div class="mt-4" x-data="{}"
                    ...
                    <div><x-input-error for="password" class="mt-2"/></div>

                    <div class="flex mt-6">
                        <div class="flex-grow">
                            <flux:button x-on:click="$flux.modal('confirm-logout').close()" wire:loading.attr="disabled">
                                {{ __('Cancel') }}
                            </flux:button>
                        </div>
                        <div class="flex-shrink-0">
                            <flux:button variant="primary" class="ms-3"
